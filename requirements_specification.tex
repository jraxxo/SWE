...
\renewcommand{\arraystretch}{1.25}
\rowcolors{2}{tableEven}{tableOdd}
\noindent\begin{tabularx}{\textwidth}{|cclcm{0.46cm}r>{\cellcolor{white}}r|>{\cellcolor{white}}c>{\cellcolor{white}}r>{\cellcolor{white}}r}
\cline{1-7}
...
& 2 & Distributed data processing & & 			& 5 	& 4.0 & & & \\
& 3 & Rate of transactions & & 					& 5 	& 5.0 & & & \\
\mystrut & 4a & Numerical Operations & &		& 10	& 7.0 & & & \\
\mystrut & 4b & Control Procedures & &			& 5		& 4.5 & & & \\
\mystrut & 4c & Exception Management & &		& 10	& 9.0 & & & \\
\mystrut\rotatezzz & 4d & Logical Flows & &		& 5		& 4.0 & & & \\
& 5 & Reusability & &							& 5		& 2.5 & & & \\
& 6 & Database Conversions & &					& 5		& 5.5 & & & \\
...
\noindent\begin{tabularx}{\textwidth}{|cm{0.28cm}lccrm{1.3cm}cr|>{\cellcolor{white}}l}
\cline{1-9}
Q & & Qualification Coefficient & 0.01 & x 		& 		& \hfill 119 & = & 1.19 & \\ \cline{1-9}
\multicolumn{9}{c}{} \\
\cline{1-9}
qFP & & Qualified Function Points & E & x 		&		& \hfill rFP & = & 228.48 & \\
\cline{1-9}
\multicolumn{9}{c}{} \\
\cline{1-9}
